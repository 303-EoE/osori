...
![system_architecture_full](https://osori-bucket.s3.ap-northeast-2.amazonaws.com/image_public/A303+System+Architecture.png)
<br/>

### 개발&테스트 서버구조

![system_architecture_develop_test](https://osori-bucket.s3.ap-northeast-2.amazonaws.com/image_public/A303+System+Architecture+Develop_Test+Server.PNG)
<br/>

### 배포 서버구조

![system_architecture_release1](https://osori-bucket.s3.ap-northeast-2.amazonaws.com/image_public/A303+System+Architecture+Release+Server1.PNG)
<br/>

### 배포 서버구조 (Redis, MariaDB 통신)

![system_architecture_release2](https://osori-bucket.s3.ap-northeast-2.amazonaws.com/image_public/A303+System+Architecture+Release+Server2.PNG)
