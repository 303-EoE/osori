...
abstract class $UserInfoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String nickname, String profileImageUrl});
}
...
class _$UserInfoModelImpl implements _UserInfoModel {
  ...
  @override
  String toString() {
    return 'UserInfoModel(id: $id, nickname: $nickname, profileImageUrl: $profileImageUrl)';
  }
...
abstract class _UserInfoModel implements UserInfoModel {
  factory _UserInfoModel(
      ...
      required final String profileImageUrl}) = _$UserInfoModelImpl;
